...
LAYER_SPECS = [
    ...
    layer_spec(
        "toilets",
        "Public toilets",
        "public_toilet_block_pt_t1eam.parquet",
        stream="Overlays (not in index)",
        geometry="point",
        color="#7C3AED",
        popup_fields=["name", "suburb", "ward", "address", "function_use", "qa_flag"],
        default_on=False,
        point_radius=7,
    ),
    layer_spec(
        "dog_bags",
        "Dog bag dispensers",
        "dog_dispenser_bags_pt_t1eam.parquet",
        stream="Overlays (not in index)",
        geometry="point",
        color="#F6871F",
        popup_fields=[
...
def build_filter_index(*, force: bool) -> dict:
    ...
    for layer_id, parquet in [
        ...
        ("toilets", "public_toilet_block_pt_t1eam.parquet"),
        ("dog_bags", "dog_dispenser_bags_pt_t1eam.parquet"),
