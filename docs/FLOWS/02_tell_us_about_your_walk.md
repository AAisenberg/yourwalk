...
- Hilliness is disclosure only (Mostly flat / hills / Steep sections + climb and/or descent), on the same line as time and distance. It does not change Day / Night / Footpaths pills
